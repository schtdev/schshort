    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Update page</h4>
                ...
                <form action="{{route('pageupdate', $item->slug)}}" method="POST">
                        @csrf
                        @method('PUT')
                    <div class="modal-body row">
                        <div class="form-group col-md-4">
                            <label for="name">Page name: <small>Minimum 4 character is required</small></label>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="footer" class="form-control">
                              <option selected>Select one</option>
                                <option value="1" {{$item->footer == '1' ? 'selected' : ''}}>Yes</option>
                                <option value="0" {{$item->footer == '0' ? 'selected' : ''}}>No</option>
                            </select>
                        </div>
